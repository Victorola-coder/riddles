...
export default function LeaderboardPage() {
  ...
  const mockGlobalLeaderboard: LeaderboardEntry[] = [
    { rank: 1, username: 'RiddleMaster', totalGems: 5420, riddlesSolved: 287, currentStreak: 45 },
    { rank: 2, username: 'BrainTeaser', totalGems: 4890, riddlesSolved: 245, currentStreak: 32 },
    { rank: 3, username: 'PuzzleWizard', totalGems: 4320, riddlesSolved: 216, currentStreak: 28 },
    { rank: 4, username: 'You', totalGems: totalGemsEarned, riddlesSolved: solvedRiddles.length, currentStreak, isCurrentUser: true },
    { rank: 5, username: 'LogicLord', totalGems: 3650, riddlesSolved: 182, currentStreak: 15 },
    { rank: 6, username: 'MindBender', totalGems: 3420, riddlesSolved: 171, currentStreak: 12 },
    { rank: 7, username: 'ThinkTank', totalGems: 3180, riddlesSolved: 159, currentStreak: 9 },
    { rank: 8, username: 'QuizKing', totalGems: 2950, riddlesSolved: 147, currentStreak: 7 },
  ];

  const mockWeeklyLeaderboard: LeaderboardEntry[] = [
    { rank: 1, username: 'SpeedSolver', totalGems: 890, riddlesSolved: 45, currentStreak: 7 },
    { rank: 2, username: 'DailyGrinder', totalGems: 820, riddlesSolved: 41, currentStreak: 7 },
    { rank: 3, username: 'You', totalGems: Math.min(totalGemsEarned, 750), riddlesSolved: Math.min(solvedRiddles.length, 38), currentStreak, isCurrentUser: true },
    { rank: 4, username: 'WeekWarrior', totalGems: 680, riddlesSolved: 34, currentStreak: 6 },
  ...
  const getRankIcon = (rank: number) => {
    switch (rank) {
      ...
      default:
        return <span className="text-white/60 font-cinzel font-bold text-lg">#{rank}</span>;
    }
  };
          ...
          {currentLeaderboard.map((entry) => (
            <div
              ...
              className={`glass-card p-4 md:p-5 transition-all hover:scale-[1.01] ${
                entry.isCurrentUser
                  ? 'ring-2 ring-purple bg-purple/10'
                  : ''
              }`}
            >
